  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.metrics} aria-label="분석 범위">
        ...
        <Metric label="전처리 제외" value={`${number.format(data.preprocessing.excludedRowCount)}건`} />
        <Metric label="원본 파일" value={`${data.fileCount}개`} />
        <Metric label="분석 플랫폼" value={`${data.platforms.length}곳`} />
        <Metric label="최고 평균가" value={money(data.expensive.mean)} />
        <Metric label="최고 평균가 모델" value={data.expensive.product ?? "N/A"} />
      </section>
      ...
      <section className={styles.dashboardControls} aria-label="상품 분류와 세부 검색">
        <div className={styles.controlHeading}><p className={styles.kicker}>02 / CLASSIFY & FILTER</p><h2>상품 분류 및 세부 검색</h2></div>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}><p className={styles.kicker}>03 / VISUAL READOUT</p><h2>가격 그래프</h2></div>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}><p className={styles.kicker}>04 / MODEL DISTRIBUTION</p><h2>상품·모델별 가격 분포</h2></div>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}><p className={styles.kicker}>05 / QUARTERLY SIGNALS</p><h2>분기별 지표</h2></div>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}><p className={styles.kicker}>06 / RANK CORRELATION</p><h2>가격과 참여 지표</h2></div>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}><p className={styles.kicker}>07 / CATEGORY GAP</p><h2>대분류 품목별 플랫폼 차이</h2></div>
